...
{message_body}"
        ...
        msg = await interaction.response.send_message("✅ ข้อความถูกส่งเรียบร้อย!", ephemeral=False)
...
class SetupView(View):
    ...
    @discord.ui.button(label="🔍 พิมพ์ชื่อเพื่อค้นหา", style=discord.ButtonStyle.secondary)
    async def search_by_name(self, interaction: discord.Interaction, button: Button):
